...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initObjects() {
        inputValidation = new InputValidation(activity);  // first validation is done then db store while register
    ...
    private void postDataToSQLite() {
        ...
        else if (!inputValidation.isInputEditTextMatches(textInputEditTextPassword, textInputEditTextConfirmPassword, textInputLayoutConfirmPassword, getString(R.string.error_password_match))){
            return;
        }

        else if (!dbHelper.checkUserExists(textInputEditTextEmail.getText().toString().trim())){
